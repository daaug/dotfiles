...
hi LineNr           guifg=#9a9a9a     guibg=black       gui=NONE      ctermfg=darkgray    ctermbg=NONE        cterm=NONE
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi MatchParen     guifg=white     guibg=blue     gui=BOLD      ctermfg=white       ctermbg=darkgray    cterm=NONE
  hi Pmenu          guifg=#f6f3e8     guibg=#282828     gui=NONE      ctermfg=white       ctermbg=darkgray    cterm=NONE
